...
export function FeedbackForm({ isOpen, onClose }: FeedbackFormProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-2xl shadow-large border border-white/30 dark:border-gray-700/50 w-full max-w-lg max-h-[90vh] overflow-y-auto animate-scale-in">
